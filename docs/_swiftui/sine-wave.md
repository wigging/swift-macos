...
To draw a sine wave, create a shape that draws a line using given x and y values. The values must be converted to the proper points within the view's frame. Markers represent points on the drawn line.

![sine wave](/swift-macos/images/sine-wave.png)
...
![sine wave python](/swift-macos/images/sine-wave-python.png)
